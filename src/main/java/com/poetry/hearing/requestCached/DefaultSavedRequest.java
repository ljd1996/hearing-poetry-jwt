...
public class DefaultSavedRequest implements SavedRequest {
    ...
    private DefaultSavedRequest(DefaultSavedRequest.Builder builder) {
        this.cookies = new ArrayList();
        this.locales = new ArrayList();
        this.headers = new TreeMap(String.CASE_INSENSITIVE_ORDER);
        this.parameters = new TreeMap();
    ...
    public boolean doesRequestMatch(HttpServletRequest request, PortResolver portResolver) {
        if (!this.propertyEquals("pathInfo", this.pathInfo, request.getPathInfo())) {
            ...
            return false;
        } else if (!this.propertyEquals("serverPort", this.serverPort, portResolver.getServerPort(request))) {
            return false;
        } else if (!this.propertyEquals("requestURL", this.requestURL, request.getRequestURL().toString())) {
            return false;
            ...
            return !this.propertyEquals("contextPath", this.contextPath, request.getContextPath()) ? false : this.propertyEquals("servletPath", this.servletPath, request.getServletPath());
        }
    }
    ...
    public static class Builder {
        ...
        public DefaultSavedRequest.Builder setLocales(List<Locale> locales) {
            this.locales = locales;
            return this;
        }

        public DefaultSavedRequest.Builder setHeaders(Map<String, List<String>> header) {
            this.headers.putAll(header);
            return this;
        }

        public DefaultSavedRequest.Builder setParameters(Map<String, String[]> parameters) {
            this.parameters = parameters;
            return this;
        }

        public DefaultSavedRequest.Builder setContextPath(String contextPath) {
            this.contextPath = contextPath;
            return this;
        }

        public DefaultSavedRequest.Builder setMethod(String method) {
            this.method = method;
            return this;
        }

        public DefaultSavedRequest.Builder setPathInfo(String pathInfo) {
            this.pathInfo = pathInfo;
            return this;
        }

        public DefaultSavedRequest.Builder setQueryString(String queryString) {
            this.queryString = queryString;
            return this;
        }

        public DefaultSavedRequest.Builder setRequestURI(String requestURI) {
            this.requestURI = requestURI;
            return this;
        }

        public DefaultSavedRequest.Builder setRequestURL(String requestURL) {
            this.requestURL = requestURL;
            return this;
        }

        public DefaultSavedRequest.Builder setScheme(String scheme) {
            this.scheme = scheme;
            return this;
        }

        public DefaultSavedRequest.Builder setServerName(String serverName) {
            this.serverName = serverName;
            return this;
        }

        public DefaultSavedRequest.Builder setServletPath(String servletPath) {
            this.servletPath = servletPath;
            return this;
        }

        public DefaultSavedRequest.Builder setServerPort(int serverPort) {
